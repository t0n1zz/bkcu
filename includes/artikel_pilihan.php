...
class artikel_pilihan{
	public static $nama_tabel="artikel_pilihan";
	protected static $db_fields = array('id','judul','gambar','content','penulis','tanggal','status');
	...
	protected $upload_dir="images_pilihan";
