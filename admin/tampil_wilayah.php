    ...
    if(empty($errors)){
        ...
        try{
            if($wilayah_cuprimer->save()){
                ...
                $message = "Gagal mengubah nama wilayah";
        }catch(PDOException $e){
            error_notice($e);
            $message = "Gagal mengubah nama wilayah";
        } 
...
if(isset($_POST['btnhapus'])){
    ...
    if($jumlah_artikel2 == 0){
        ...
        $message .= "<a href=\"tampil_cuprimer.php?wilayah={$id2kategori}\">Lihat CU</a>";
    }
}
                ...
                <div class="panel panel-default">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php
                            ...
                            $sql_tampil = "SELECT count(cu.wilayah) as countwilayah,w.id,w.name,cu.wilayah";
                            $sql_tampil .=" FROM " .wilayah_cuprimer::$nama_tabel. " w";
                            $sql_tampil .=" LEFT JOIN " .cuprimer::$nama_tabel. " cu";
                            $sql_tampil .=" ON w.id = cu.wilayah";
                            $sql_tampil .=" GROUP BY w.id";
