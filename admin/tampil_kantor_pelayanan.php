...
$thispage = "tampil_kantor_pelayanan";
...
<head>
    ...
    <title>Puskopdit BKCU Kalimantan Admin Site -- Kelola Kantor Pelayanan</title>
...
<body>
    <div id="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><span class="fa fa-archive"></span> Kelola Kantor Pelayanan</h1>
            </div>           
        </div>
        <!-- /header -->            
                    ...
                    <form class="form-inline" role="form" action="tampil_artikel.php">
                        <div class="form-group">
                            <a type="button" data-toggle="tooltip" data-placement="top" 
                                ...
                                class="btn btn-default" href="tambah_kantor_pelayanan.php"><span class="fa fa-plus"></span> Tambah Kantor Pelayanan</a>
                        </div>
                    </form>
                    </div>
                    <!-- /.panel-heading -->
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th>Nama</th>
                                <th>Alamat</th>
                                <th>Kota/Kecamatan/Kelurahan</th>
                               ...
                               $output = "<tr>";
                                    if(!empty($row['id']))
                                        $output .="<td><a data-toggle=\"tooltip\" data-placement=\"top\" 
                                                        ...
                                                        href=\"ubah_kantor_pelayanan.php?kantor={$row['id']}\"
                                                        >{$row['id']}</a></td>";
                                    else
                                        $output .="<td>-</td>";
    ...
    <div class="modal fade" id="modal2show" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
       <form role="form" action="tampil_kantor_pelayanan.php" method="post">
