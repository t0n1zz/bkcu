...
$thispage = "tambah_artikel_pilihan";
...
<head>
    ...
    <title>Puskopdit BKCU Kalimantan Admin Site -- Tambah Artikel Pilihan</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><span class="fa fa-plus"></span> Tambah Artikel Pilihan</h1>
                </div>           
            </div>
            <!-- /header --> 
            <!-- alert -->
                ...
                ?>
              <!-- /alert --> 
                <form role="form" method="post" action="tambah_artikel_pilihan.php" enctype="multipart/form-data">
