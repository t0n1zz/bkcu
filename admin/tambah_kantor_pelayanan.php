...
$thispage = "tambah_kantor_pelayanan";
...
<head>
    ...
    <title>Puskopdit BKCU Kalimantan Admin Site -- Tambah Kantor Pelayanan</title>
...
<body>
    <div id="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><span class="fa fa-plus"></span> Tambah Kantor Pelayanan</h1>
            </div>           
        </div>
        <!-- /header -->            
        ...
        <div class="row">
            ...
            ?>
            <!-- /alert --> 
                <form role="form" method="post" action="tambah_kantor_pelayanan.php">
                <div class="panel panel-default">
                    <div class="panel-heading tooltip-demo">
                        ...
                        <button type="submit" name="simpanbaru" data-toggle="tooltip" data-placement="top" 
                                    title="Menyimpan data kantor pelayanan dan memulai menambah kantor pelayanan" 
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
                          <label>Alamat</label>
                          <textarea class="form-control" name="alamat" placeholder="Masukkan alamat" style=" height:100px"></textarea>
                        </div>
                        </div>
                        <div class="col-lg-12">
                        <div class="form-group">
