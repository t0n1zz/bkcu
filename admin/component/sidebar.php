        ...
        <ul class="nav" id="side-menu">
            ...
            ><a href="#"><i class="fa fa-book fa-fw"></i> Artikel<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a <?php if($thispage == "tambah_artikel_pilihan") echo "class=\"active \"" ?>
                         href="tambah_artikel_pilihan.php"><span class="fa fa-plus"></span> Tambah Artikel Pilihan</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a <?php if($thispage == "tampil_artikel_pilihan") echo "class=\"active \"" ?>
                        href="tampil_artikel_pilihan.php"><span class="fa fa-archive"></span> Kelola Artikel Pilihan</a>
                    </li>
                    <li>
