...
<head>
    ...
    <title>Puskopdit BKCU Kalimantan Admin Site -- Tambah Staff</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><span class="fa fa-plus"></span> Tambah Staff</h1>
                </div>           
            </div>
            <!-- /header --> 
            <!-- alert -->
                ...
                ?>
              <!-- /alert --> 
                <form role="form" method="post" action="tambah_staff.php" enctype="multipart/form-data">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading tooltip-demo">
                        ...
                        <button type="submit" name="simpanbaru" data-toggle="tooltip" data-placement="top" 
                                    title="Menyimpan gambar kegiatan dan memulai menambah staff baru" 
                        ...
                        <button type="submit" name="batal" data-toggle="tooltip" data-placement="top" 
                                    title="Batal menambah staff dan kembali ke halaman Kelola staff" 
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" 
                                    placeholder="Silahkan masukkan nama staff"/>
                        </div>
                        </div>
                        <!--/judul-->
                        <!--judul-->
